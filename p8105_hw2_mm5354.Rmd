...
#Create a new variable showing the proportion of responses that were “Excellent” or “Very Good”
  mutate(., propotion_response = (Excellent + `Very good`)/(Excellent + `Very good` + Fair + Good + Poor))
```
